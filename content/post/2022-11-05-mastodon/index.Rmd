...
So any tips/corrections that people have, like the reply to my first toot below from [`@rudolf@fosstodon.org`](https://fosstodon.org/web/@rudolf/109293436746688975), are welcome on [Mastodon](https://fosstodon.org/web/@robinlovelace/109297069622120822), [Twitter](https://twitter.com/robinlovelace/status/1589243690224332801), comments below or anywhere.

\<iframe src="[https://fosstodon.org/\@rudolf/109293436746688975/embed"](https://fosstodon.org/@rudolf/109293436746688975/embed") class="mastodon-embed" style="max-width: 100%; border: 0" width="400" allowfullscreen="allowfullscreen"\>\</iframe\>\<script src="[https://fosstodon.org/embed.js"](https://fosstodon.org/embed.js") async="async"\>\</script\>
