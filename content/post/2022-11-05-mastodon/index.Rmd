...
- Getting set-up
- Crossposting to Twitter with [moa.party](#moa)
- Thoughts on appropriate social media platforms for the 2020s

# Introduction: why Mastodon

Twitter has been purchased by Elon Musk, a prominent technologist and car salesperson with questionable judgement.
...
Furthermore, with #mastodon trending on Twitter itself, it seems there is a group dynamic element to the mass uptake of Mastodon.
...
# Crossposting with moa.party (#moa)
...
I have just set-up a recurring donation to fosstodon.org: if that allows it to grow, while providing good content to its users and hopefully minimising downtime, it's money well spent for me.
