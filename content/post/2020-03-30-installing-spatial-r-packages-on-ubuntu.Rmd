...
```{r, echo=FALSE, fig.cap="The Etroware Proteus, my new Linux laptop"}
knitr::include_graphics("https://www.entroware.com/store/image/cache/catalog/entroware/products/laptops/el07r3/proteus-el07r3-front-open-400x500.jpg")
```
