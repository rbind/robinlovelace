...
I recently completed the book [Human Compatible](https://en.wikipedia.org/wiki/Human_Compatible) by Professor of Computer Science at Berkeley, [Stuart Russell](https://en.wikipedia.org/wiki/Stuart_J._Russell) [@russell_human_2019].
...
In my case, the technology is fairly narrow and, as far as I am aware, can only be used for the definitively benign activity of cycle network planning [@lovelace_propensity_2017].
